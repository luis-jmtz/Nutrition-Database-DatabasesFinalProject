...
from queries import query_ingredients_by_calories, query_user_favorite_recipes, print_df, query_ingredients_by_NutritionDensity, query_recipes_by_ingredient, query_user_favorite_ingredients
...
q1 = query_user_favorite_recipes(cursor, 1)
